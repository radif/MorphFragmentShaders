...
void main()
{
    ...
    if(touchPont1==undefVec){
        ...
        touchPont2=touchPont1;
        touchPont2Inverted=touchPont1Inverted;
    }

    
    
    float influence1=influence(touchPont1);
    float influence2=influence(touchPont2);
    ...
    //influence=1.0;
    coords=coords-relativeDistance1*influence1+relativeDistance1;
    coords=coords-relativeDistance2*influence2+relativeDistance2;
