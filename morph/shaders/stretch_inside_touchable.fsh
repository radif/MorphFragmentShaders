...
void main()
{
    ...
    //how much influence?
    float temp=(distance*1.5) *PI-PI*.5;
    //temp=clamp(temp,-PI*.5,PI*.5);
    float influence=sin(temp);//traction and stretching
    //float influence=cos(temp);//traction and stretching
    ...
    //influence=1.0;
    coords=coords-relativeDistance*influence+relativeDistance;
